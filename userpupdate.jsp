    ...
    <div class="div2" style="height: 1000px;">
       <div class="reservation">
           <%
               ...
               %>
                <h1>Update Here</h1>
                    <form method="post" action="userpupdate">
                        <%
                            String u=(String)session.getAttribute("uname");
                           
                            
                            
                            String sql="select * from userlogin where username='"+u+"'";
                        ...
                        <div class="txt_field">
                            <input type="text" name="pass" value="<%=rs.getString("password")%>" >
                            <label>Password</label>
                        </div>
                            <div class="txt_field">
                            <input type="text" name="pass2" value="<%=rs.getString("password")%>" >
