            ...
            <div class="login-form">
                ...
                <div class="center">
                    ...
                    <a href="userdash.jsp" class="ab"><input type="submit" value="Dashboard" class="loginsub"></a>
                     <a href="userupdate.jsp" class="ab"><input type="submit" value="Profile Update" class="loginsub"></a>
    ...
    <div class="div2" style="height: 1100px;">
       <div class="reservation">
           <%
               ...
               %>
                <h1>Update Here</h1>
                    <form method="post" action="upreservation">
                        <%
                            int id1=Integer.parseInt(request.getParameter("id"));
                            String sql="select * from reseravation where id='"+id1+"'";
                        ...
                        <div class="txt_field">
                            ...
                            <div class="txt_field">
                            <input type="text" name="fn" readonly value="<%=rs.getString("fullname")%>" >
                            <label>Full Name</label>
                        </div>
                        <div class="txt_field">
                            <input type="text" name="a" value="<%=rs.getString("travelc")%>" >
                            <label>Travel Class</label>
                        </div>
                        <div class="txt_field">
                            <input type="text" name="ad" value="<%=rs.getString("adults")%>" >
                            <label>No of Adults</label>
                        </div>
                        <div class="txt_field">
                            <input type="text" name="ki" value="<%=rs.getString("kids")%>" >
                        ...
                        <div class="txt_field">
                            <input type="date" name="rd" value="<%=rs.getString("retdate")%>" >
