...
<li><a href="experience.html">EXPERIENCE</a></li>
    ...
    <%
        ...
        while(rs.next()){
			...
			<tbody>
                            ...
                            <td><a href='block.jsp?a=<%=rs.getString("id")%>&b=<%=rs.getString("FirstName")%>&c=<%=rs.getString("lastname")%>&d=<%=rs.getString("Type")%>&e=<%=rs.getString("username")%>&g=<%=rs.getString("email")%>&h=<%=rs.getString("password")%>' style="background-color: #4CAF50; 
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  ...
  font-size: 16px;">Block</a></td>
                            <td><a href='edit.jsp?d=<%=rs.getString("id")%>'style="background-color: #f44336; 
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
