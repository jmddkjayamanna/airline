<%-- 
    Document   : experience
    Created on : Apr 27, 2021, 5:53:10 PM
            ...
            <div class="login-form" style="height: auto;">
                ...
                <div class="center" style="border-bottom: none;">
                     ...
                     <label  class="close-btn fas fa-times"></label>
                                          <h1>You Are Logged As Staff Grade 1</h1>

                     <p style="font-family:'Emirates'; Color:#0088dd; font-size: 20px;">Username :${uname} </p>
                     <a style="background-color: transparent;" href="staff1dash.jsp"><input type="submit" value="Dashboard" class="loginsub" style="margin-top: 10px;" ></a>
