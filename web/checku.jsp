...
<li><a href="experience.jsp">EXPERIENCE</a></li>
 	...
 	Logged
            ...
            <div class="login-form">
                ...
                <div class="center">
                    ...
                    <a href="admindash.jsp" class="ab"><input type="submit" value="Dashboard" class="loginsub"></a>
    ...
    <h1>Approve Staff</h1>
        ...
        <table class="styled-table" style="margin-left:-250px;">
		<thead>
		<tr>
			<th>Staff Id</th>
			<th>First Name</th>
    ...
    <%
        ...
        while(rs.next()){
			...
			<tbody>
                            ...
                            <td><a href='approve.jsp?a=<%=rs.getString("id")%>&b=<%=rs.getString("FirstName")%>&c=<%=rs.getString("LastName")%>&d=<%=rs.getString("Type")%>&e=<%=rs.getString("username")%>&f=<%=rs.getString("Grade")%>&g=<%=rs.getString("email")%>&h=<%=rs.getString("password")%>' style="background-color: #4CAF50; 
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  ...
  font-size: 16px;">Approve</a></td>
                            <td><a href='delete.jsp?d=<%=rs.getString("id")%>'style="background-color: #f44336; 
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
