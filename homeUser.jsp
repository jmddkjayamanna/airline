            ...
            <div class="login-form">
                ...
                <div class="center">
                     ...
                     <p style="font-family:'Emirates'; Color:#0088dd; font-size: 20px;">Username :${uname} </p>
                        <a style="background-color: white;" href="userdash.jsp"><input type="submit" value="Dashboard" class="loginsub"></a>
                        <a style="background-color: white;" href="userpupdate.jsp"><input type="submit" value="Update Profile" class="loginsub"></a>
