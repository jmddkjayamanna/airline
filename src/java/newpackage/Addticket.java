...
public class Addticket extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //processRequest(request, response);
         int ticketno=Integer.parseInt(request.getParameter("tId"));
        String passengername=request.getParameter("pname");
        int seatno=Integer.parseInt(request.getParameter("seatno"));
        
        String boardtime=request.getParameter("btime");
        ...
        connection m=new connection();
         m.Addticket(ticketno,passengername,seatno,boardtime,depdate,flightno,tclass);
