 ...
 */
@WebServlet(name = "reserve2", urlPatterns = {"/reserve2"})
public class reserve2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int seats=adults+kids;
           ...
           d.addReserve2(fname,depcountry,aricountry,travelclass,adults,kids,country,ddate,rdate,id,email,triptype,seats);
