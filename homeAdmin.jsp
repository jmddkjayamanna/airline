 	...
 	Logged
            ...
            <div class="login-form">
                ...
                <div class="center">
                     ...
                     <a class="log1" href="admindash.jsp"><input type="submit" value="Dashboard" class="loginsub" ></a>
                   <a class="log1" href="Home.html"><input type="submit" value="Logout" class="loginsub"></a> 
